...
namespace Recurly {
  ...
  public class Client : BaseClient {
    ...
    /// </returns>
    public Pager<CouponRedemption> ListAccountCouponRedemptions(string accountId, string ids = null) {
      var urlParams = new Dictionary<string, object>{ { "account_id", accountId } };
    ...
    /// </returns>
    public Pager<CouponRedemption> ListInvoiceCouponRedemptions(string invoiceId, string ids = null) {
      var urlParams = new Dictionary<string, object>{ { "invoice_id", invoiceId } };
      var queryParams = new Dictionary<string, object>{ { "ids", ids } };
